...
def login(frame):
    ...
    Label(frame,text='User ID',width = 12,bg='#498C10',fg='#FFA0A0', font = stylelogin).place(x=50,y=140)
    Label(frame,text='Password',width = 12,bg='#498C10',fg='#FFA0A0', font = stylelogin).place(x=50,y=240)
...
def signup(frame):
      ...
      Label(frame,text='Enter your Name', width = 16,bg='#B0F953',fg='blue', font = stylesignup).place(x=50,y=120)
      Label(frame,text='Enter User ID', width = 16,bg='#B0F953',fg='blue', font = stylesignup).place(x=50,y=180)
      Label(frame,text='Enter Password', width = 16,bg='#B0F953',fg='blue', font = stylesignup).place(x=50,y=240)
      Label(frame,text='Select your gender', width = 25,bg='#B0F953',fg='blue', font = stylesignup).place(x=100,y=300)
      ...
      Label(frame,text='Enter phone number', width = 16,bg='#B0F953',fg='blue', font = stylesignup).place(x=50,y=410)
      uname = Entry(frame, textvariable=name, bg="#53BAF9", width =15, font=stylesignup); uname.place(x=270, y=120)
      userid=Entry(frame,textvariable=uid,bg='#53BAF9',width = 15,font=stylesignup); userid.place(x=270,y=180)
      password=Entry(frame,textvariable=pwd,bg='#53BAF9',width = 15,font=stylesignup,show="*"); password.place(x=270,y=240)
      phone=Entry(frame,textvariable=phone,bg='#53BAF9',width = 15,font=stylesignup); phone.place(x=270,y=410)
      signup_btn = Button(frame,text='Sign Up',width = 10,bg="#fbf5ab",fg='blue',command=sign_up,font=stylesignup)
